...
[CreateAssetMenu(fileName = "TerrainDensityDataOld", menuName = "Scriptable Objects/TerrainDensityDataOld")]
public class TerrainDensityDataOld : ScriptableObject
{
    ...
    // 2D or 3D Noise
    public NoiseDimension[] noiseDimensionOptions = new NoiseDimension[] {NoiseDimension._2D, NoiseDimension._3D};
