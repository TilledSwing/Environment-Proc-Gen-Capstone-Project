...
[CreateAssetMenu(fileName = "TerrainDensityData1", menuName = "Scriptable Objects/TerrainDensityData1")]
public class TerrainDensityData1 : ScriptableObject
{
    ...
    // Default Values
    // Noise and Fractal Settings
    public fnl_noise_dimension defaultNoiseDimension = fnl_noise_dimension._3D;
    public fnl_noise_type defaultNoiseType = fnl_noise_type.OpenSimplex2;
    public fnl_fractal_type defaultNoiseFractalType =fnl_fractal_type.FBm;
    ...
    public fnl_domain_warp_type defaultDomainWarpType = fnl_domain_warp_type.OpenSimplex2;
    public fnl_domain_warp_fractal_type defaultDomainWarpFractalType = fnl_domain_warp_fractal_type.None;
    ...
    // Cellular(Voronoi) Values
    public fnl_cellular_distance_func defaultCellularDistanceFunction = fnl_cellular_distance_func.EuclideanSq;
    public fnl_cellular_return_type defaultCellularReturnType = fnl_cellular_return_type.Distance;
    public float defaultCellularJitter = 1;
    // Terrain Values
    public int defaultWidth = 32;
    public int defaultHeight = 100;
    public float defaultNoiseScale = 0.6f;
    public float defaultIsolevel = 0.5f;
    public int defaultWaterLevel = 35;
